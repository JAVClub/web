<template>
    <a-card hoverable style="width: 350px">
        ...
        <template class="ant-card-actions" slot="actions">
            <a-icon type="delete" key="delete" v-on:click="deleteMetadata(JAVinfo.id)" />
        </template>
    </a-card>
</template>
...
export default {
    ...
    methods: {
        ...
        deleteMetadata: function(metadataId) {
            this.$emit('metadataDelete', metadataId)
        }
    }
}
</script>
